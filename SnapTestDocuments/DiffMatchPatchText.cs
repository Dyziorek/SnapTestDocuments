...
namespace SnapTestDocuments
{
    ...
    public class Patch
    {
        ...
        public override string ToString()
        {
            ...
            foreach (Diff aDiff in this.diffs)
            {
                ...
                text.Append(DiffMatchPatchText.encodeURI(aDiff.text)).Append("\n");
            }
     ...
     */
    public class DiffMatchPatchText
    {
        // Defaults.
        // Set these on your DiffMatchPatchText instance to override the defaults.
